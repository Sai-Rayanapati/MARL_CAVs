...
episode_rewards = '/eval_results.npy'
obs_window = 100
...
"""medium mode"""
medium_maa2c_0 = np.load('../results/Apr_18_19_34_47' + episode_rewards)
...
medium_maacktr_0 = np.load('../results/Apr_18_19_41_09' + episode_rewards)
...
##############################
medium_mappo_0 = np.load('../results/Apr_18_19_39_16' + episode_rewards)
...
ax1.plot(X, medium_maa2c_0[:obs_window], lw=line_size_others, label='MADQN', linestyle=':',
         color=color_cycle[colors[0]])
# ax1.fill_between(X, medium_maa2c_lower_bound[:obs_window], medium_maa2c_upper_bound[:obs_window],
#                  facecolor=color_cycle[colors[0]], edgecolor='none', alpha=alpha)

ax1.plot(X, medium_maacktr_0[:obs_window], lw=line_size_others, label='MAACKTR', linestyle=':',
         color=color_cycle[colors[1]])
# ax1.fill_between(X, medium_maacktr_lower_bound[:obs_window], medium_maacktr_upper_bound[:obs_window],
#                  facecolor=color_cycle[colors[1]], edgecolor='none', alpha=alpha)

ax1.plot(X, medium_mappo_0[:obs_window], lw=line_size_others, label='MAPPO', linestyle=':',
